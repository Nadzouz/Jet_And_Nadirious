 ...
 * Nqme : Nqdir Serhir
 * Dqte : 19/01/23
 * Description : Jeu 2d Jet Shooter
 */
...
namespace Nadzouz_Figher_jet
{
    public partial class Form1 : Form
    {
        ...
        private void mainGameTimerEvent(object sender, EventArgs e)
        {
            ...
            if(enemyOne.Top > 892 || enemyTwo.Top > 892 || enemyThree.Top > 892)
            {
                gameOver(); 
            }


            //Logique de mouvement du joueur au debut
            if (goLeft == true && player.Left > 0)
            {
                player.Left -= playerSpeed;
            }
            //Logique de mouvement du joueur à la fin
        ...
        private void gameOver()
        {
            isGameOver = true;
            gameTimer.Stop();
            txtScore.Text += Environment.NewLine + "Game Over!!" + Environment.NewLine + "Appuyer sur Entrée pour recommecer .";
        }
    }
}
